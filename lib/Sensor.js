...
class Sensor {
  ...
  checkNewTemperature (newTemperature) {
    if (this.absoluteChange(this._temperature, this._lastEmittedTemperature) > this._eventsStep) {
  ...
  checkNewHumidity (newHumidity) {
    if (this.absoluteChange(this._humidity, this._lastEmittedHumidity) > this._eventsStep) {
